...
# Filter samples of interest (e.g., agua, sedimento, subcutícula o biofilm)
sample_type <- "sedimento"  # Change here to the type of sample you want to analyze
...
# Metadata column to use for grouping (e.g., "site_loc", "classes", "type", etc.)
metadata_column <- "site_loc"  # Change according to what you want to analyze
...
func_long_samples <- Funct_samples %>%
  ...
  rename(Sample = !!metadata_column)  # 'Sample' indicates the selected metadata column (e.g., site_loc, type, clases)
